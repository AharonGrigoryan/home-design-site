...
const FeatureCard = (props) => {
  return (
    <div className={`feature-card4-feature-card ${props.rootClassName} `}>
      ...
      <h2 className="feature-card4-text">Lorem ipsum</h2>
      <span className="feature-card4-text1">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates
        reiciendis rerum excepturi blanditiis incidunt! A incidunt architecto
        libero expedita distinctio, nostrum aperiam esse
      </span>
    </div>
  );
};
